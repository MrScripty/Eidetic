...
- Remaining: durable child plans do not yet expose a review/projection route or explicit rejection/abandon command for generated plans the user chooses not to apply.
