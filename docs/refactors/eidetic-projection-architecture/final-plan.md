...
- Remaining: AI child planning must emit durable bible reference proposals through the new semantic command path, review actions still need accept/reject commands, accepted proposals must compose atomically with bible graph commands, and graph-backed AI context projections are still needed before proposal review can drive propagation.
