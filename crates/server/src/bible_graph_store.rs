use eidetic_core::contracts::{
    BibleGraphField, BibleGraphFieldId, BibleGraphFieldKey, BibleGraphNode, BibleGraphNodeId,
    BibleGraphNodeListProjection, BibleGraphPart, BibleGraphPartId, BibleGraphPartKey,
    BibleGraphPartProjection, BibleGraphSchemaKey, BibleNodeDetailProjection, ChangeEventId,
    FieldValue, ObjectKind, ProjectionEnvelope, ProjectionVersion, SetBibleGraphFieldCommand,
...
pub(crate) fn load_node_detail_projection(
    ...
    let parts = load_part_projections(conn, node_id)?;
