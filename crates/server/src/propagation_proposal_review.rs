use eidetic_core::contracts::{
    ...
    ObjectRevision, PropagationProposal, PropagationProposalId, RejectPropagationProposalCommand,
    RevisionOperation, SemanticProposalStatus,
};
...
pub(crate) fn proposal_status_revision(
