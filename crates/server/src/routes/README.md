...
| `commands.rs` | Projection-owned command endpoints that write through backend history storage, including object-field, bible-graph node, and canonical-root commands. |
